...
HD_PWD='C:/Users/51249/Documents/Tencent Files/512491013/FileRecv/Camera_RGB_Demo/Camera_RGB_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Camera_RGB_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Camera_RGB_Demo.tcl -notrace
